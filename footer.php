<div class="foo">
    ...
    <div class="col-lg-4">
      <div class="propos">
        ...
        <p>Ce mini projet concu dans le cadre des projects fin d'étude asigner aux etudiantes par leur proffesseurs ...........<br><a href="admin/index.php">Administration</a>
      </p>
    ...
    <div class="col-lg-4">
      ...
      <div class="team">        
        <ul>
          <h2 class="foo-headline">Projet est créé par:</h2>

          <li><a herf="#">Sabrina Ladjal </a></li>
          <li><a herf="#">Ikram BK </a></li>
        </ul>
      </div>  
...
<div class="rights" >
  © 2023 copyrights to <span class="italic">UBMA</span>
</div>
